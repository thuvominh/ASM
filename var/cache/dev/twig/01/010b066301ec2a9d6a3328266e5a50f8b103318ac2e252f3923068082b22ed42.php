...
class __TwigTemplate_029ec16269b697381a00eff2e5fbad646217b484d38817cdcaf4c53fca226b24 extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            if ((isset($context["display"]) || array_key_exists("display", $context) ? $context["display"] : (function () { throw new RuntimeError('Variable "display" does not exist.', 18, $this->source); })())) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["admin"]) {
                    // line 35
                    echo "                                ";
                    if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["admin"], "dashboardActions", [], "any", false, false, false, 35)), 0))) {
                        // line 36
                        echo "                                    <tr>
...
{% block block %}
    ...
    {% endfor %}
{% endblock %}
", "@SonataAdmin/Block/block_admin_list.html.twig", "C:\\Users\\LENOVO\\ASM\\ASM\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Block\\block_admin_list.html.twig");
    }
}
