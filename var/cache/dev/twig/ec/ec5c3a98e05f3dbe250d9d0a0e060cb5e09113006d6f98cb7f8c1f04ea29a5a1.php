...
class __TwigTemplate_a14a8ec36ef0b272b10d043d261c6e5121df648322191ceab0c08d5b45347fbd extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_block($context, array $blocks = [])
    {
        ...
        // line 16
        echo "    ";
        $context["has_results"] = (1 === twig_compare((isset($context["results_count"]) || array_key_exists("results_count", $context) ? $context["results_count"] : (function () { throw new RuntimeError('Variable "results_count" does not exist.', 16, $this->source); })()), 0));
        // line 17
        echo "    ";
...
{% endblock %}
", "@SonataAdmin/Block/block_search_result.html.twig", "C:\\Users\\LENOVO\\ASM\\ASM\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Block\\block_search_result.html.twig");
    }
}
