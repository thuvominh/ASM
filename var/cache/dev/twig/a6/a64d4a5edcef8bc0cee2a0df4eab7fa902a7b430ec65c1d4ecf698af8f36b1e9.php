...
class __TwigTemplate_a56601881ea8ae427aaeebe9c69110c756df71e2f046e07f8ef0da1d5567bcf6 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 39, $this->source); })()), "key_translation_domain", [], "any", false, false, false, 39) === null)) {
                ...
                if (twig_test_iterable($context["val"])) {
                    // line 54
                    echo twig_call_macro($macros["__internal_parse_1"], "macro_render_array", [$context["val"], (isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 54, $this->source); })())], 54, $context, $this->getSourceContext());
                } else {
                    // line 56
...
{% macro render_array(value, options = []) %}
    ...
    {%- endapply -%}
{% endmacro %}
", "@SonataAdmin/CRUD/base_array_macro.html.twig", "C:\\Users\\LENOVO\\ASM\\ASM\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\base_array_macro.html.twig");
    }
}
