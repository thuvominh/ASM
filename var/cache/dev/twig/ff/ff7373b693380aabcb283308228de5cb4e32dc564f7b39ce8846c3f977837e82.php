...
class __TwigTemplate_0dced09f64ea82edd58b66f14291e924a1d3ee14d56f97f732936ef49304ea9d extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"";
            ...
            <div class=\"";
                ...
                if (!$context['_iterated']) {
                    // line 31
                    echo "                            ";
                    if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["form_group"]) || array_key_exists("form_group", $context) ? $context["form_group"] : (function () { throw new RuntimeError('Variable "form_group" does not exist.', 31, $this->source); })()), "empty_message", [], "any", false, false, false, 31), false))) {
                        // line 32
                        echo "                                ";
...
{% endmacro %}
", "@SonataAdmin/CRUD/base_edit_form_macro.html.twig", "C:\\Users\\LENOVO\\ASM\\ASM\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\base_edit_form_macro.html.twig");
    }
}
