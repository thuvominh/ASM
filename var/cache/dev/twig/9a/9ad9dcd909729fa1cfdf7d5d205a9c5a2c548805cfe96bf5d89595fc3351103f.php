...
class __TwigTemplate_0dfee52a4c1de8c73436774c44837de5d7349e53d62680c19b29892344c9597e extends Template
{
    private $source;
    private $macros = [];
...
{% if admin.hasAccess('create') and admin.hasRoute('create') %}
    ...
    {% endif %}
{% endif %}
", "@SonataAdmin/Button/create_button.html.twig", "C:\\Users\\LENOVO\\ASM\\ASM\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Button\\create_button.html.twig");
    }
}
