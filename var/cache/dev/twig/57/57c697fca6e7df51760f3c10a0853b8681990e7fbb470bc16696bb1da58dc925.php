...
class __TwigTemplate_05c6c9016298b2a76aae8966a412ae381a47176742f85880c20e598b979968cd extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["name"] => $context["view_group"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["show_field_name"]) {
                ...
                echo "                    <tr class=\"sonata-ba-view-container\">
                        ";
                // line 45
                if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["admin"] ?? null), "show", [], "any", false, true, false, 45), $context["show_field_name"], [], "array", true, true, false, 45)) {
                    // line 46
                    echo "                            ";
                    echo $this->env->getRuntime('Sonata\AdminBundle\Twig\RenderElementRuntime')->renderViewElement($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 46, $this->source); })()), "show", [], "any", false, false, false, 46), $context["show_field_name"], [], "array", false, false, false, 46), (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 46, $this->source); })()));
                    echo "
                        ";
                }
                // line 48
    ...
    <div class=\"sonata-ba-view\">
        {% for name, view_group in admin.showgroups %}
            <table class=\"table table-bordered\">
                ...
                {% for show_field_name in view_group.fields %}
                    <tr class=\"sonata-ba-view-container\">
                        {% if admin.show[show_field_name] is defined %}
                            {{ admin.show[show_field_name]|render_view_element(object) }}
                        {% endif %}
                    </tr>
                {% endfor %}
            </table>
...
{% endblock %}
", "@SonataAdmin/CRUD/preview.html.twig", "C:\\Users\\LENOVO\\ASM\\ASM\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\preview.html.twig");
    }
}
