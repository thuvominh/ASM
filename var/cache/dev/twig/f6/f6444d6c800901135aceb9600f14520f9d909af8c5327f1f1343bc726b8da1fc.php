...
class __TwigTemplate_d3671ff66cb7d07ad4085712ba29c3273761935bc57b779533775e9b41a8e536 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_max_per_page($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 23, $this->source); })()), "uniqid", [], "any", false, false, false, 23), "html", null, true);
        echo "_per_page\">";
    ...
    <select class=\"per-page small form-control\" id=\"";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 25, $this->source); })()), "getperpageoptions", [], "any", false, false, false, 25));
        foreach ($context['_seq'] as $context["_key"] => $context["per_page"]) {
            // line 26
            echo "            <option ";
            if ((0 === twig_compare($context["per_page"], twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 26, $this->source); })()), "datagrid", [], "any", false, false, false, 26), "pager", [], "any", false, false, false, 26), "maxperpage", [], "any", false, false, false, 26)))) {
                echo "selected=\"selected\"";
            }
            echo " value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 26, $this->source); })()), "generateUrl", [0 => (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 26, $this->source); })()), 1 => ["filter" => twig_array_merge(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 26, $this->source); })()), "datagrid", [], "any", false, false, false, 26), "getPaginationParameters", [0 => 1], "method", false, false, false, 26), "filter", [], "any", false, false, false, 26), [twig_constant("Sonata\\AdminBundle\\Datagrid\\DatagridInterface::PER_PAGE") =>             // line 27
$context["per_page"]])]], "method", false, false, false, 26), "html", null, true);
            // line 28
            echo "\">";
            // line 29
...
";
    ...
    {
        return array (  163 => 32,  156 => 30,  154 => 29,  152 => 28,  150 => 27,  144 => 26,  140 => 25,  136 => 24,  129 => 23,  119 => 22,  108 => 19,  105 => 18,  95 => 17,  79 => 13,  69 => 12,  59 => 22,  56 => 21,  54 => 17,  51 => 16,  49 => 12,  46 => 11,);
    }
...
{% endblock %}
", "@SonataAdmin/Pager/base_results.html.twig", "C:\\Users\\LENOVO\\ASM\\ASM\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Pager\\base_results.html.twig");
    }
}
