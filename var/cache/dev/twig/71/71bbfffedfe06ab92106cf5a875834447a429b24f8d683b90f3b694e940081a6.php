...
class __TwigTemplate_f8c2aed8921ca5f6df98c740306fb5b786149398782f126648e4305a86e098cd extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 14, $this->source); })()), "hasAccess", [0 => "show", 1 => (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 14, $this->source); })())], "method", false, false, false, 14)) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source,         // line 15
...
{% endif %}
", "@SonataAdmin/Button/show_button.html.twig", "C:\\Users\\LENOVO\\ASM\\ASM\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Button\\show_button.html.twig");
    }
}
