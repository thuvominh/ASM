 ...
 */
class getCategoryBookRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoryBookRepository' shared autowired service.
     *
     * @return \App\Repository\CategoryBookRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoryBookRepository.php';

        return $container->privates['App\\Repository\\CategoryBookRepository'] = new \App\Repository\CategoryBookRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
