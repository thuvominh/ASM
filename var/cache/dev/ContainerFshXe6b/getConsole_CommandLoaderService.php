...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'sonata.admin.command.generate_object_acl' => ['privates', 'sonata.admin.command.generate_object_acl', 'getSonata_Admin_Command_GenerateObjectAclService', true],
            'sonata.admin.command.list' => ['privates', 'sonata.admin.command.list', 'getSonata_Admin_Command_ListService', true],
            'sonata.admin.command.setup_acl' => ['privates', 'sonata.admin.command.setup_acl', 'getSonata_Admin_Command_SetupAclService', true],
