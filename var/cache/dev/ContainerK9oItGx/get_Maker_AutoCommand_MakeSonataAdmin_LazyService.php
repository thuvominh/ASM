...
class get_Maker_AutoCommand_MakeSonataAdmin_LazyService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['.maker.auto_command.make_sonata_admin.lazy'] = new \Symfony\Component\Console\Command\LazyCommand('make:sonata:admin', [], 'Generates an admin class based on the given model class', false, function () use ($container): \Symfony\Bundle\MakerBundle\Command\MakerCommand {
